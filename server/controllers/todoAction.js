...
async function buildPDF(todo, todo_id) {
    return new Promise((resolve, reject) => {
        ...
        const filePath = path.join(pdfDir, `todo_${todo_id}.pdf`);
        ...
        function printRow(label, value) {
            doc.font("Helvetica-Bold").fontSize(13).text(label, labelX, startY);
            doc.font("Helvetica").fontSize(13).text(safe(value), valueX, startY);
            startY += lineHeight;
            doc.moveTo(50, startY - 8).lineTo(550, startY - 8).stroke("#e0e0e0");
        }
        ...
        doc.fontSize(10).fillColor("gray")
            .text("PDF generated by Stylic Todo App", 50, startY + 20, { align: "center" })
            .text(`Generated on: ${new Date().toLocaleString()}`, 50, startY + 35, { align: "center" });
